...
public class FragmentEmpat extends Fragment {
    ...
    private int page;
    String[] listArray={"Jagung", "Ubi Kayu", "Kacang Hijau", "Padi"};

    public static FragmentEmpat newInstance(int page, String taitel){

        FragmentEmpat fragmentAwal = new FragmentEmpat();
