...
public class PosLima extends Fragment {
    @Nullable
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps4.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosLima.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        if(pDialog.isShowing());
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosLima.super.getContext(), contactList,
