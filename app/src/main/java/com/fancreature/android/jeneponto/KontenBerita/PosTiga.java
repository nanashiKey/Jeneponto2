...
public class PosTiga extends Fragment {
    @Nullable
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps2.php";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new PosTiga.GetContacts().execute();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosTiga.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosTiga.super.getContext(), contactList,
