...
public class FragmentLima extends Fragment {
    ...
    private int page;
    String[] listArray={"Kuda", "Sapi", "Kerbau", "Kambing","Unggas"};

    public static FragmentLima newInstance(int page, String taitel){

        FragmentLima fragmentAwal = new FragmentLima();
