...
public class PosEmpat extends Fragment {
    @Nullable
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps3.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosEmpat.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        if(pDialog.isShowing());
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosEmpat.super.getContext(), contactList,
