...
public class PosTujuh extends Fragment {
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps6.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosTujuh.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        if(pDialog.isShowing());
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosTujuh.super.getContext(), contactList,
