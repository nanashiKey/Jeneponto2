...
public class PosEnam extends Fragment {
    @Nullable
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps5.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosEnam.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        if(pDialog.isShowing());
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosEnam.super.getContext(), contactList,
