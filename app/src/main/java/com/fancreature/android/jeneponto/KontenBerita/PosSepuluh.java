...
public class PosSepuluh extends Fragment {
    @Nullable
    ...
    TextView x;
    private static String url = "http://visitjeneponto.id/connection/getisiberitaapps9.php";
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PosSepuluh.super.getContext());
...
//                        contact.put("created_by", by);
        ...
        if(pDialog.isShowing());
            ...
            ListAdapter adapter = new SimpleAdapter(
                    PosSepuluh.super.getContext(), contactList,
